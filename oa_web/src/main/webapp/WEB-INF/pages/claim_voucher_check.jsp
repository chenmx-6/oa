...
<%@ page import="com.miles.oa.global.Constant" %>
                ...
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        <c:forEach items="${recorders}" var="recorder">
                            <div class="col-md-1">${recorder.dealer.name}</div>
                            <div class="col-md-3"><spring:eval expression="recorder.dealTime"/></div>
                            <div class="col-md-1">${recorder.dealWay}</div>
                            <div class="col-md-2">${recorder.dealResult}</div>
                            <div class="col-md-5">备注：${recorder.comment}</div>
                        </c:forEach>
                    </div>
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.employee.post==Constant.POST_DM || sessionScope.employee.post==Constant.POST_GM}">
